...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "create_game_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/games",
        "method": "POST",
        "description": "Create a new game and verify it returns a valid game object with waiting status",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "create_game_returns_null_moves",
        "category": "HAPPY_PATH",
        "endpoint": "/games",
        "method": "POST",
        "description": "Verify newly created game has null player moves and null winner",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "make_move_player1_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Create a game, then submit player 1's move and verify game is still waiting",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": null,
    ...
    {
        "name": "make_move_complete_game_player1_wins",
        "category": "HAPPY_PATH",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Create a game, player 1 picks rock, player 2 picks scissors \u2014 player1 wins",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Create a game, both players pick rock \u2014 result is draw",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": null,
    ...
    {
        "name": "make_move_game_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Attempt to make a move on a non-existent game ID",
        "request_data": {
            "path": {
                "id": "0000000000000000"
            },
    ...
    {
        "name": "make_move_invalid_player",
        "category": "INVALID_INPUT",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Submit a move with invalid player number (3), expect 422 validation error",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": null,
    ...
    {
        "name": "make_move_invalid_choice",
        "category": "INVALID_INPUT",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Submit a move with invalid choice 'lizard', expect 422 validation error",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": null,
...
BASE_URL = os.path.expandvars("http://127.0.0.1:8080")
