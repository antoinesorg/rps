...
Generated at: 2026-03-16T23:00:17.490981+00:00
Project: rps
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/games",
        "method": "POST",
        "description": "Create a new game and verify it returns status 201 with correct initial game state",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
        ...
        "actual_response": {
            ...
            "status": "waiting",
            "winner": null,
            "created_at": "2026-03-13T01:53:04+00:00"
        }
    },
    {
        "name": "create_game_verify_initial_fields",
        "category": "HAPPY_PATH",
        "endpoint": "/games",
        "method": "POST",
        "description": "Create a new game and verify all fields are present with correct initial values: player1_move=null, player2_move=null, status=waiting, winner=null, id is 16-char hex, created_at is ISO 8601",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "create_game_unique_ids",
        "category": "HAPPY_PATH",
        "endpoint": "/games",
        "method": "POST",
        "description": "Create a game to verify it gets a unique ID (each game should have a distinct 16-char hex ID)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
