...
Generated at: 2026-03-13T01:51:35.864161+00:00
Project: rps
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a game, submit player 1's move (rock), verify game is still waiting",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": {},
    ...
    {
        "name": "make_move_game_completes_with_winner",
        "category": "HAPPY_PATH",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
    ...
    {
        "name": "make_move_game_completes_with_draw",
        "category": "HAPPY_PATH",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
    ...
    {
        "name": "make_move_invalid_player_number",
        "category": "INVALID_INPUT",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Submit a move with invalid player number (3), expect 422 with validation error",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": {},
    ...
    },
    {
        ...
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Submit a move with invalid choice (dynamite), expect 422 with validation error",
        "setup": {
            "endpoint": "/games",
            "method": "POST",
            "body": {},
    ...
    },
    {
        ...
        "endpoint": "/games/{id}/moves",
        "method": "POST",
        "description": "Submit a move for a non-existent game ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": "nonexistent_game_id_abc123"
            },
            "query": {},
            "body": {
                "player": 1,
    ...
    {
        "name": "make_move_duplicate_player_move",
        "category": "INVALID_INPUT",
        "endpoint": "/games/{id}/moves",
        "method": "POST",
...
BASE_URL = os.path.expandvars("http://127.0.0.1:8081")
